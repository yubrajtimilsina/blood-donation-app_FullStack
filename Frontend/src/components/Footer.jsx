        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
          ...
          <div>
            ...
            <nav className="space-y-3">
              {/* Scroll links (same-page navigation) */}
              <ScrollLink
                to="hero"
                smooth={true}
                duration={1000}
                className="block text-gray-600 hover:text-red-600 hover:underline transition-colors duration-200 cursor-pointer"
              >
                Home
              </ScrollLink>
              ...
              {/* Router links (page navigation) */}


              <RouterLink
                to="/login"
                className="block text-gray-600 hover:text-red-600 hover:underline transition-colors duration-200"
              >
                Admin Portal
              </RouterLink>
              ...
              <RouterLink
                to="/emergency"
                className="block text-red-600 hover:text-red-700 hover:underline font-semibold transition-colors duration-200"
              >
                Emergency Request
              </RouterLink>
            </nav>
          ...
          <div>
            ...
            <div className="space-y-3 text-gray-600">
              <div className="flex items-start gap-3">
                ...
                <span className="text-sm">123 LifeLink Avenue<br />Medical District, Pokhara<br />Nepal </span>
              </div>
        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <div className="text-center md:text-left">
            <p className="text-gray-600 text-sm">
              &copy; 2025 <span className="font-semibold text-red-600">LifeLink</span>. All rights reserved.
            </p>
